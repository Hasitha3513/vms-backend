...
public record VehicleDailyActivityResponse(UUID activityId, UUID companyId, String companyCode, UUID vehicleId, UUID driverId, UUID projectId, LocalDate activityDate, Instant startTime, Instant endTime, BigDecimal startOdometerKm, BigDecimal endOdometerKm, BigDecimal engineHours, BigDecimal distanceKm, String workDescription, String remarks, Instant createdAt) {}
