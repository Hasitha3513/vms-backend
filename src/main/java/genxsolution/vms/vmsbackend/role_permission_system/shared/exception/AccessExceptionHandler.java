...
public class AccessExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleNotFound(AccessResourceNotFoundException ex) {
    ...
    public ResponseEntity<ErrorResponseDto> handleForbidden(SecurityException ex) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(
                new ErrorResponseDto(Instant.now(), HttpStatus.FORBIDDEN.value(), HttpStatus.FORBIDDEN.getReasonPhrase(), ex.getMessage(), List.of())
        );
    }
